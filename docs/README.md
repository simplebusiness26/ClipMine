...
- [Market validation](product/market-validation.md)
- [Business model and launch](product/business-model-and-launch.md)
...
- [AI clipping pipeline](technical/ai-pipeline.md)
